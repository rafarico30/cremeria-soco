...
function HomePage() {
  ...
  <button className="font-lobsterTwo text-letterColor font-extrabold text-5xl w-1/2 p-4 border-black border-4 flex items-center shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-800">
  ...
  <button className="font-lobsterTwo text-letterColor font-extrabold text-5xl w-1/2 p-4 border-black border-4 flex items-center shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-2xl hover:shadow-gray-900">
    <img src={queso} alt="queso" className="w-48 h-48 mr-32 ml-8" />
    Quesos
  </button>
  <button className="font-lobsterTwo text-letterColor font-extrabold text-5xl w-1/2 p-4 border-black border-4 flex items-center shadow-none transition-shadow duration-400 cursor-pointer hover:shadow-2xl hover:shadow-gray-900">
  ...
  <button 
    onClick={() => navigate('/')} 
    className="bg-redColor rounded-lg font-bold px-4 py-1 hover:bg-red-400 hover:border-red-400 transition duration-300"
  >
  ...
  className="bg-footColor rounded-lg font-bold px-4 py-1 hover:bg-red-400 hover:border-red-400 transition duration-300">
